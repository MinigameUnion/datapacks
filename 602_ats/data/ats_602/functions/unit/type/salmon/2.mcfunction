...
tellraw @a[tag=join_area_602] [{"text":"["},{"nbt":"item.tag.Name","entity":"@s","interpret":true},{"text":"] Score: "},{"score": {"name": "@s","objective": "z1_602"},"color":"gold"},{"text":" → "},{"text":"["},{"nbt":"item.tag.Name","entity":"@e[sort=furthest,limit=1,tag=salmon_check_602]","interpret":true},{"text":"]"}]
