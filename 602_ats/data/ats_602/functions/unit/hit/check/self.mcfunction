...
execute if entity @s[tag=parrot_602,scores={z1_602=0}] if score @s mulScore2_602 < @e[limit=1,tag=hit_partner_602] mulScore2_602 run function ats_602:unit/type/parrot/self
