...
execute if entity @e[limit=1,tag=hit_partner_602,tag=parrot_602] if score @e[limit=1,tag=hit_partner_602] mulScore1_602 < @s mulScore1_602 run function ats_602:unit/type/parrot/partner
