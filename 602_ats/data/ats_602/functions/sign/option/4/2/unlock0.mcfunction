execute store result score $o_4_602 a1_602 run data get storage ats_602:main ChaosOptions.Cost.L2
...
execute if score $o_4_602 a1_602 <= @s coin_000 run function ats_602:sign/option/4/2/unlock1
