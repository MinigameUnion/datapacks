...
tellraw @s [{"text":"色付きではない","bold":true,"color":"red"},{"text":"ガラスブロック","bold":true,"color":"aqua"},{"text":"の上で","color":"white"},{"text":"アイテムを手に持った状態で","bold":true,"color":"white"},{"text":"シフトキー長押し","bold":true,"color":"yellow"},{"text":"して発射します。","color":"white"},{"text":"[次へ]","bold":true,"underlined":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/trigger click_602 set 4"}}]
