execute unless entity @s[x=6014,y=0,z=14,dx=36,dy=255,dz=36] run kill @s
execute positioned as @s rotated as @s run function ats_602:tile/0
...
execute if entity @s[tag=stop_602,tag=hit_602] positioned as @s run function ats_602:tile/1
