execute if entity @s[tag=start_602] run function ats_602:tile/type/tropical_fish/0
...
execute if entity @s[tag=result_602] run function ats_602:tile/type/tropical_fish/result