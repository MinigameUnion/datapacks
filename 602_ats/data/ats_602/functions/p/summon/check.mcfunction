execute unless block ~ 79 ~ minecraft:glass run function ats_602:p/summon/error0
execute unless data entity @s SelectedItem.tag.602 run function ats_602:p/summon/error1
