...
execute if entity @s[scores={sneak_602=30..}] positioned as @s unless block ~ 79 ~ minecraft:glass run function ats_602:tile/summon/error0
execute if entity @s[scores={sneak_602=30..}] positioned as @s unless data entity @s SelectedItem.tag.602 run function ats_602:tile/summon/error1
