#say 後
execute if entity @s[scores={b_602=0..17999}] run scoreboard players set @s d_602 18000
execute if entity @s[scores={b_602=-18000..-1}] run scoreboard players set @s d_602 -18000
