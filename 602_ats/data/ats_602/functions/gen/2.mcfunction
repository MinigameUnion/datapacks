...
execute if score $gen602 a_602 matches 8 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/1

execute if score $gen602 a_602 matches 9 run function ats_602:gen/r
execute if score $gen602 a_602 matches 9 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/2

execute if score $gen602 a_602 matches 10 run function ats_602:gen/r
execute if score $gen602 a_602 matches 10 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/3

execute if score $gen602 a_602 matches 11 run function ats_602:gen/r
execute if score $gen602 a_602 matches 11 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/4

execute if score $gen602 a_602 matches 12 run function ats_602:gen/r
execute if score $gen602 a_602 matches 12 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/5

execute if score $gen602 a_602 matches 13 run function ats_602:gen/r
execute if score $gen602 a_602 matches 13 positioned 6016 64 47 rotated -90 0 run function ats_602:gen/p/6
...
execute if score $gen602 a_602 matches 15 positioned 6016 64 16 rotated 0 0 run function ats_602:gen/p/c2

execute unless score $gen602 a_602 matches 16.. run schedule function ats_602:gen/2 2t append
