...
# ミニが足りていればガチャを回す
  execute if score @s coin_000 matches 5000.. unless entity @e[type=cod,tag=suiryu_taratara_401.cod] run function suiryu_taratara_401:gacha/play/001_summon_cod
