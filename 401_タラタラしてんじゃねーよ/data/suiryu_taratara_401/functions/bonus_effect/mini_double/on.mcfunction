#> suiryu_taratara_401:bonus_effect/mini_double/on
#
# 獲得ミニ2倍
# ON
#
# @within function suiryu_taratara_401:bonus_effect/mini_double/off
...
# 所持ミニが消費ミニより多ければON
  ...
  ## 看板書き換え
    execute if score @s coin_000 >= #miniCount_401 suiryu_taratara_401.trigger run data modify block 3991 51 2 Text1 set value '{"text":"獲得ミニ2倍","color":"yellow","clickEvent":{"action":"run_command","value":"/execute unless score #PremiumTicketUsing suiryu_taratara_401.trigger matches 1 run function suiryu_taratara_401:bonus_effect/mini_double/off"}}'
    execute if score @s coin_000 >= #miniCount_401 suiryu_taratara_401.trigger run data modify block 3991 51 2 Text4 set value '{"text":"ON","color":"yellow"}'

  ## スコアセット
    execute if score @s coin_000 >= #miniCount_401 suiryu_taratara_401.trigger run scoreboard players set #BonusEffect.miniDouble suiryu_taratara_401.trigger 1
