#> suiryu_taratara_401:weapons/select_trident
#
# トライデントを選択する
# 看板右クリックで実行
#
# @within function suiryu_taratara_401:weapons/select_trident
...
# 次のトライデントへ
  scoreboard players add #SelectedTrident suiryu_taratara_401.trigger 1
