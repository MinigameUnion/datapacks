#> suiryu_taratara_401:weapons/select_crossbow
#
# クロスボウを選択する
# 看板右クリックで実行
#
# @within function suiryu_taratara_401:weapons/select_crossbow
...
# 次のクロスボウへ
  scoreboard players add #SelectedCrossbow suiryu_taratara_401.trigger 1
