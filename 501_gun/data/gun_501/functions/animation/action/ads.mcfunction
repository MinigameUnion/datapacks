...
execute unless data storage gun_501:temp tag.animation.temp[0] run data modify storage gun_501:temp tag.CustomModelData set from storage gun_501:temp tag.animation.ads.value
