...
execute if score #HIT num_501 matches 0 if score #Y pos_501 matches 0 unless score #Y ope_501 matches 0 if score #X ope_501 matches 1.. positioned ~1 ~ ~ run function bullet_501:gap/x
execute if score #HIT num_501 matches 0 if score #Y pos_501 matches 0 unless score #Y ope_501 matches 0 if score #X ope_501 matches ..-1 positioned ~-1 ~ ~ run function bullet_501:gap/x
