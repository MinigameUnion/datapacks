...
#execute if score #HIT num_501 matches 0 if score #Y ope_501 matches ..-1 positioned ~ ~-1 ~ run function bullet_501:gap/y
execute if score #HIT num_501 matches 0 if score #X pos_501 matches 0 unless score #X ope_501 matches 0 if score #Z ope_501 matches 1.. positioned ~ ~ ~1 run function bullet_501:gap/z
execute if score #HIT num_501 matches 0 if score #X pos_501 matches 0 unless score #X ope_501 matches 0 if score #Z ope_501 matches ..-1 positioned ~ ~ ~-1 run function bullet_501:gap/z
