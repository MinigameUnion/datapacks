...
execute if score #y num_501 matches 4375..5625 if score #x num_501 matches 8750..10000 if score #HIT num_501 matches 0 run function #bullet_501:detailed/hit
...
execute if score #x num_501 matches 7500..8750 if score #y num_501 matches 0..10000 if score #HIT num_501 matches 0 run function #bullet_501:detailed/hit
...
execute if score #y num_501 matches 1250..2500 if score #x num_501 matches 5625..7500 if score #HIT num_501 matches 0 run function #bullet_501:detailed/hit
