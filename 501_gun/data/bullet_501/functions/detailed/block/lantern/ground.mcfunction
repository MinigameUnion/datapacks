...
execute if score #x num_501 matches 3125..6875 if score #z num_501 matches 3125..6875 if score #y num_501 matches 0..4375 run function #bullet_501:detailed/hit
...
execute if score #x num_501 matches 3750..6250 if score #z num_501 matches 3750..6250 if score #y num_501 matches 4375..5625 run function #bullet_501:detailed/hit
...
execute if score #SKIP num_501 >= #DETAILED num_501 run function bullet_501:detailed/block/lantern/ground