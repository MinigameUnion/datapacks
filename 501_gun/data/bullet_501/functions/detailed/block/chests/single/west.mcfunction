...
execute if score #x num_501 matches 0..1250 if score #z num_501 matches 4375..5625 if score #y num_501 matches 4375..6875 run function #bullet_501:detailed/hit/metal
...
execute if score #SKIP num_501 >= #DETAILED num_501 run function bullet_501:detailed/block/chests/single/west