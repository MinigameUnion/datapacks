...
scoreboard players set #z max_501 625
scoreboard players set #z min_501 0
scoreboard players set #x max_501 10000
scoreboard players set #x min_501 8750
execute if score #x num_501 matches 8750..10000 if score #z num_501 matches 0..625 if score #y num_501 matches 4375..6875 run function #bullet_501:detailed/hit/metal
...
scoreboard players set #z min_501 0
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..9375 if score #z num_501 matches 0..9375 if score #y num_501 matches 0..8750 run function #bullet_501:detailed/hit
...
execute if score #SKIP num_501 >= #DETAILED num_501 run function bullet_501:detailed/block/chests/right/east