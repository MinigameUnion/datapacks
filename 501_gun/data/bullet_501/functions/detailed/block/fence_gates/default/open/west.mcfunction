...
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..1875 if score #y num_501 matches 3750..9375 run function #bullet_501:detailed/hit
scoreboard players set #x max_501 5625
scoreboard players set #y max_501 5625
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..5625 if score #y num_501 matches 3750..5625 run function #bullet_501:detailed/hit
scoreboard players set #y max_501 9375
scoreboard players set #y min_501 7500
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..5625 if score #y num_501 matches 7500..9375 run function #bullet_501:detailed/hit
