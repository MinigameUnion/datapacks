...
execute if score #z num_501 matches 3750..6250 if score #y num_501 matches 1875..7500 run function #bullet_501:detailed/hit
...
scoreboard players set #z min_501 0
execute if score #HIT num_501 matches 0 if score #z num_501 matches 0..1250 if score #y num_501 matches 1875..8125 run function #bullet_501:detailed/hit
scoreboard players set #z max_501 10000
scoreboard players set #z min_501 8750
execute if score #HIT num_501 matches 0 if score #z num_501 matches 8750..10000 if score #y num_501 matches 1875..8125 run function #bullet_501:detailed/hit