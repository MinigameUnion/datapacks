...
execute if score #HIT num_501 matches 0 if score #z num_501 matches 8125..9375 if score #y num_501 matches 1875..7500 run function #bullet_501:detailed/hit
scoreboard players set #z min_501 4375
scoreboard players set #y max_501 3750
execute if score #HIT num_501 matches 0 if score #z num_501 matches 4375..9375 if score #y num_501 matches 1875..3750 run function #bullet_501:detailed/hit
scoreboard players set #y max_501 7500
scoreboard players set #y min_501 5625
execute if score #HIT num_501 matches 0 if score #z num_501 matches 4375..9375 if score #y num_501 matches 5625..7500 run function #bullet_501:detailed/hit
