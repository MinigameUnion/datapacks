...
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..1875 if score #y num_501 matches 1875..7500 run function #bullet_501:detailed/hit
scoreboard players set #x max_501 5625
scoreboard players set #y max_501 3750
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..5625 if score #y num_501 matches 1875..3750 run function #bullet_501:detailed/hit
scoreboard players set #y max_501 7500
scoreboard players set #y min_501 5625
execute if score #HIT num_501 matches 0 if score #x num_501 matches 625..5625 if score #y num_501 matches 5625..7500 run function #bullet_501:detailed/hit
