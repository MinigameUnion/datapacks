...
execute if score #HIT num_501 matches 0 if score #x num_501 matches 3750..6250 if score #z num_501 matches 0..1250 run function #bullet_501:detailed/hit/others

scoreboard players set #z max_501 10000
scoreboard players set #z min_501 8750
execute if score #HIT num_501 matches 0 if score #x num_501 matches 3750..6250 if score #z num_501 matches 8750..10000 run function #bullet_501:detailed/hit/others
...
scoreboard players set #z max_501 10000
scoreboard players set #z min_501 0
execute if score #HIT num_501 matches 0 if score #y num_501 matches 8125..9375 if score #x num_501 matches 4375..5625 run function #bullet_501:detailed/hit/planks/dark_oak
...
execute if score #SKIP num_501 >= #DETAILED num_501 run function #bullet_501:detailed/block/bell/floor/east