execute if score #y num_501 <= #y max_501 run function #bullet_501:detailed/hit/fluid
...
execute if score #SKIP num_501 >= #DETAILED num_501 run function bullet_501:detailed/fluid/loop