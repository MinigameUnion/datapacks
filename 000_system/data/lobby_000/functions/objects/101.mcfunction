...
## インタラクションの設置
    summon interaction ~ ~ ~ {Tags:[click_000,click.101_000],width:1.1f,height:2}
...
## ディスプレイの設置
    ...
    # タイトル
    summon text_display ~ ~3.3 ~ {Tags:[click_000,click.101_000,temp_000],text:'{"text":"\\u0001","font":"lobby_000:default"}',billboard:"vertical",background:0,transformation:[1f,0f,0f,0f, 0f,1f,0f,0f, 0f,0f,1f,0f, 0f,0f,0f,5f],brightness:{sky:15,block:15}}
    # クリック
