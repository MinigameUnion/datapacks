...
## ディスプレイの設置
    ...
    # タイトル
    summon text_display ^ ^3.1 ^-0.5 {Tags:[click_000,click.602_000,temp_000],text:'{"text":"\\u0801","font":"lobby_000:default"}',billboard:"vertical",background:0,transformation:[1f,0f,0f,0f, 0f,1f,0f,0f, 0f,0f,1f,0f, 0f,0f,0f,4f],brightness:{sky:15,block:15}}
    # 画面
    summon text_display ^ ^1.715 ^-0.025 {Tags:[click_000,click.801_000,temp_000],text:'{"text":"\\u1801","font":"lobby_000:default"}',background:0,transformation:{translation:[0f,0f,0f],left_rotation:{axis:[1f,0f,0f],angle:-0.3925f},scale:[0.15f,0.15f,0.15f],right_rotation:[0f,0f,0f,1f]},brightness:{sky:15,block:15}}
    # クリック
