...
## ディスプレイの設置
    ...
    # タイトル
    summon text_display ~ ~3.1 ~ {Tags:[click_000,click.602_000,temp_000],text:'{"text":"\\u0006","font":"lobby_000:default"}',billboard:"vertical",background:0,transformation:[1f,0f,0f,0f, 0f,1f,0f,0f, 0f,0f,1f,0f, 0f,0f,0f,4f],brightness:{sky:15,block:15}}
    # クリック
