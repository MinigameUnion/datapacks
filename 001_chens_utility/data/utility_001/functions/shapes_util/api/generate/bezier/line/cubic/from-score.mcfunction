#> utility_001:shapes_util/api/generate/bezier/line/cubic/from-score
# @public
# @input
...
execute store result entity 0-0-1-0-6 Pos[0] double 0.01 run scoreboard players get $control-b-X shape_input_001
execute store result entity 0-0-1-0-6 Pos[1] double 0.01 run scoreboard players get $control-b-Y shape_input_001
execute store result entity 0-0-1-0-6 Pos[2] double 0.01 run scoreboard players get $control-b-Z shape_input_001
