...
#タイマーの設定
scoreboard players set @e[tag=PacMan_102,type=item_display] _Timer_102 5
...
scoreboard players remove @e[tag=Ghost_base_102,type=item_display,scores={_State_102=0}] _Count_102 1

#サウンド
execute as @a[scores={playing_000=102}] at @s run playsound minecraft:block.note_block.didgeridoo voice @s ~ ~ ~ 1 2

#エサの削除
kill @e[tag=Pellet_102,type=item_display,dx=0,dy=0,dz=0,limit=1]