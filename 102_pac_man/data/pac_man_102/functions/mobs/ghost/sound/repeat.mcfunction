...
#サウンドを鳴らす
execute if score #ghost_sound_102 _Operation_102 matches 1 at @e[tag=Center_102] run function pac_man_102:mobs/ghost/sound/normal
execute if score #ghost_sound_102 _Operation_102 matches 2 at @e[tag=Center_102] run function pac_man_102:mobs/ghost/sound/spurt_1
execute if score #ghost_sound_102 _Operation_102 matches 3 at @e[tag=Center_102] run function pac_man_102:mobs/ghost/sound/spurt_2
execute if score #ghost_sound_102 _Operation_102 matches 4 at @e[tag=Center_102] run function pac_man_102:mobs/ghost/sound/izike
execute if score #ghost_sound_102 _Operation_102 matches 5 at @e[tag=Center_102] run function pac_man_102:mobs/ghost/sound/death