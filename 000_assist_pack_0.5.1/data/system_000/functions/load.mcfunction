...
setblock 0 0 0 shulker_box{CustomName:'[{"text":"[破壊厳禁]assist_packで使用します","color":"dark_red"}]',Lock:"?"} replace
setblock 0 1 0 air
summon armor_stand 0.0 0.0 0.0 {UUID: [I; 0, 0, 0, 0], Tags: ["admin_000"], Invisible: 1b, Small: 1b, Invulnerable: 1b, Marker: 1b}
...
#バージョン管理
scoreboard players set #DataVersion id_000 2580
...
data modify storage system_000:storage version.minecraft set value '{"text":"1.16.3"}'
