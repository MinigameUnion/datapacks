...
execute if score @s hit_502 matches 2.. if score @s hit_502 < #PERFECT num_502 run title @a[tag=ticking_502] title [{"score":{"objective":"hit_502","name":"@s"},"color":"white","bold":true},{"text":" HITS","color":"gray","bold":false}]
...
title @a[tag=ticking_502] subtitle [{"text":"in ","color":"gray","bold":false},{"score":{"objective":"num_502","name":"#PERFECT"},"color":"gray","bold":false},{"text":" clays","color":"gray","bold":false}]
