...
execute as @e[type=!player,dx=47,dy=31,dz=31,tag=ticking_502] run function tool_000:entity/delete
kill @e[dx=47,dy=31,dz=31,tag=hit_mark_501]
...
data modify entity @s ArmorItems[0].tag.match.id set value "minecraft:debug_stick"
data modify block 4992 0 2000 Items append from entity @s ArmorItems[0].tag.match
data modify storage clay_502:storage match.playing set from block 4992 0 2000 Items
data remove storage clay_502:storage match.playing[{id:"minecraft:debug_stick"}]
