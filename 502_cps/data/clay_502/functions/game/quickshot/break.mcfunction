...
execute if score @s set_502 matches 1.. run title @a[tag=ticking_502] reset
...
execute if score @s set_502 matches ..0 run function clay_502:game/quickshot/finish