...
execute if score @s progress_502 matches 6 run tellraw @a[tag=ticking_502] [{"text":"[Tutorial] ","color":"gold"},{"text": " ✓ ","color":"green","underlined": false,"bold": true},{"text": "クレー射撃 チュートリアル","color":"white","underlined": false}]
