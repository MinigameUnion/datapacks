...
tellraw @a[tag=ticking_502] [{"text":"[Tutorial] ","color":"gold"},{"text": " リロード中に ","color":"gray","underlined": false},{"keybind": "key.swapOffhand","color":"white","underlined": true},{"text": " をもう一度押すとリロードを","color":"gray","underlined": false},{"text": "中断","color":"white","underlined": false},{"text": "できます","color":"gray","underlined": false}]
