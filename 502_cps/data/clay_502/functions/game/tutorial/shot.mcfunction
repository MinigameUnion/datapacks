...
execute unless entity @a[tag=ticking_502,tag=playing_502,scores={hit_502=..2}] run scoreboard players set @s progress_502 5
execute unless entity @a[tag=ticking_502,tag=playing_502,scores={hit_502=..2}] run scoreboard players set @s tick_502 40