...
execute if score @s hologram_id_001 matches 5004 unless data storage clay_502:storage match.list[0] run function clay_502:hologram/menu/match/max
...
execute if score @s hologram_id_001 matches 5008 unless data storage clay_502:storage match.list[0] run function clay_502:hologram/menu/match/max
...
execute if score @s hologram_id_001 matches 5009 run function clay_502:hologram/menu/quickshot/root
execute if score @s hologram_id_001 matches 5010 run function clay_502:hologram/menu/quickshot/check
execute if score @s hologram_id_001 matches 5011 run function clay_502:hologram/menu/quickshot/match
execute if score @s hologram_id_001 matches 5012 unless data storage clay_502:storage match.list[0] run function clay_502:hologram/menu/match/max
execute if score @s hologram_id_001 matches 5012 if data storage clay_502:storage match.list[0] run function clay_502:hologram/menu/quickshot/create
