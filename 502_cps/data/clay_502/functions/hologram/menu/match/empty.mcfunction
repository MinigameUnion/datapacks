data modify storage utility_001:hologram_util TextGroup append value {Offset: [0.75f,-0.75f],HologramID: 5000,Setting: {CursorCollider: 0b,TextInterpret: 0b,TextSpaceWidth: 0.18f},Text: ['参','加','可','能','マ','ッ','チ','無','し']}
