...
# カーソル位置に石
    ...
    execute if score #TurnColor ReversiData_201 matches 0 unless score $sheep ReversiData_201 matches 1 run summon armor_stand ~22064 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:black_concrete",Count:1b,tag:{CustomModelData:0}}],Tags:[stone_201,Entity_201],DisabledSlots:4144959,NoGravity:1b,Invisible:1b,Invulnerable:1b}
    ...
    execute if score #TurnColor ReversiData_201 matches 1 unless score $sheep ReversiData_201 matches 1 run summon armor_stand ~22064 38.6 ~ {ArmorItems:[{},{},{},{id:"minecraft:white_concrete",Count:1b,tag:{CustomModelData:0}}],Tags:[stone_201,Entity_201],DisabledSlots:4144959,NoGravity:1b,Invisible:1b,Invulnerable:1b}
