...
execute if score #RANDOM num_000 matches 6..8 unless data storage reversi_201:data {UnlockSkins:["イリュージョン"]} run data modify storage reversi_201:data UnlockSkins append value "イリュージョン"
...
execute if score #RANDOM num_000 matches 9..11 unless data storage reversi_201:data {UnlockSkins:["フェイスA"]} run data modify storage reversi_201:data UnlockSkins append value "フェイスA"
...
execute if score #RANDOM num_000 matches 12..14 unless data storage reversi_201:data {UnlockSkins:["フェイスB"]} run data modify storage reversi_201:data UnlockSkins append value "フェイスB"
...
execute if score #RANDOM num_000 matches 15..15 unless data storage reversi_201:data {UnlockSkins:["フェイスX"]} run data modify storage reversi_201:data UnlockSkins append value "フェイスX"
...
execute if score #RANDOM num_000 matches 16..17 unless data storage reversi_201:data {UnlockSkins:["スパイラル"]} run data modify storage reversi_201:data UnlockSkins append value "スパイラル"
...
execute if score #RANDOM num_000 matches 18..18 unless data storage reversi_201:data {UnlockSkins:["スパイラルX"]} run data modify storage reversi_201:data UnlockSkins append value "スパイラルX"
...
execute if score #RANDOM num_000 matches 19..20 unless data storage reversi_201:data {UnlockSkins:["ポーン"]} run data modify storage reversi_201:data UnlockSkins append value "ポーン"
...
execute if score #RANDOM num_000 matches 21..21 unless data storage reversi_201:data {UnlockSkins:["シュルカー"]} run data modify storage reversi_201:data UnlockSkins append value "シュルカー"
...
execute if score #RANDOM num_000 matches 22..22 unless data storage reversi_201:data {UnlockSkins:["チェスト"]} run data modify storage reversi_201:data UnlockSkins append value "チェスト"
...
execute if score #RANDOM num_000 matches 23..23 unless data storage reversi_201:data {UnlockSkins:["サップリング"]} run data modify storage reversi_201:data UnlockSkins append value "サップリング"
...
execute if score #RANDOM num_000 matches 24..24 unless data storage reversi_201:data {UnlockSkins:["スパイダー"]} run data modify storage reversi_201:data UnlockSkins append value "スパイダー"
...
execute if score #RANDOM num_000 matches 25..26 unless data storage reversi_201:data {UnlockSkins:["パズルピース"]} run data modify storage reversi_201:data UnlockSkins append value "パズルピース"