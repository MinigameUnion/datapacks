#> utility_001:shapes_util/core/bezier/line/cubic/draw
# @internal
...
scoreboard players reset #c-max utility_001
scoreboard players reset #distance-c utility_001
execute store result score #from-X utility_001 run data get entity 0-0-1-0-6 Pos[0] 1000
execute store result score #from-Y utility_001 run data get entity 0-0-1-0-6 Pos[1] 1000
execute store result score #from-Z utility_001 run data get entity 0-0-1-0-6 Pos[2] 1000
...
execute at 0-0-1-0-6 facing entity 0-0-1-0-1 feet positioned 0.0 0.0 0.0 run tp 0-0-1-0-2 ^ ^ ^1 ~ ~
execute store result score #c-X utility_001 run data get entity 0-0-1-0-2 Pos[0] 1000
execute store result score #c-Y utility_001 run data get entity 0-0-1-0-2 Pos[1] 1000
execute store result score #c-Z utility_001 run data get entity 0-0-1-0-2 Pos[2] 1000
scoreboard players operation #to-X utility_001 -= #from-X utility_001
...
scoreboard players operation #c-max utility_001 > #c-Y utility_001
scoreboard players operation #c-max utility_001 > #c-Z utility_001
scoreboard players operation #distance-c utility_001 > #to-X utility_001
scoreboard players operation #distance-c utility_001 > #to-Y utility_001
scoreboard players operation #distance-c utility_001 > #to-Z utility_001
scoreboard players operation #distance-c utility_001 *= #10000 num_000
scoreboard players operation #distance-c utility_001 /= #c-max utility_001
execute as 0-0-1-0-0 at @s facing entity 0-0-1-0-5 feet run tp @s ~ ~ ~ ~ ~
execute as 0-0-1-0-5 at @s facing entity 0-0-1-0-6 feet run tp @s ~ ~ ~ ~ ~
execute as 0-0-1-0-6 at @s facing entity 0-0-1-0-1 feet run tp @s ~ ~ ~ ~ ~
...
scoreboard players operation #distance-c utility_001 /= $count shape_input_001
...
execute as 0-0-1-0-6 run scoreboard players set @s utility_001 0
scoreboard players set #t utility_001 0
tp 0-0-1-0-2 0-0-1-0-0
execute as 0-0-1-0-2 at @s run function utility_001:shapes_util/core/bezier/line/cubic/recursive