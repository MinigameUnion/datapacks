...
##ヒット判定
#敵機
execute if entity @s[tag=BulletOfPlayer_101] as @e[tag=Invader_101,type=item_display,distance=..1.5,scores={Group_101=1}] positioned ~-0.55 ~-0.78 ~-0.5 if entity @s[dx=0,dy=0,dz=0] positioned ~0.1 ~0.2 ~ if entity @s[dx=0,dy=0,dz=0] run tag @s add inRange_101
...
#自機
execute if entity @s[tag=BulletOfInvader_101] positioned ~-0.55 ~-0.58 ~-0.5 if entity @e[tag=Player_101,type=item_display,dx=0,dy=0,dz=0,scores={Group_101=1}] positioned ~0.1 ~0.2 ~ if entity @e[tag=Player_101,type=item_display,dx=0,dy=0,dz=0,scores={Group_101=1}] run function spaceinvaders_101:unit/player/hit
#トーチカ
