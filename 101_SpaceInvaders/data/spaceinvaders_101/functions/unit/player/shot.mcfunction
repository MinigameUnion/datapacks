...
## 画面上に弾がいないとき弾を召喚
    execute unless entity @e[tag=BulletOfPlayer_101,scores={Group_101=1}] if entity @e[tag=Player_101,type=item_display,scores={Group_101=1}] run playsound minecraft:block.note_block.snare voice @a[scores={playing_000=101}] ~ ~ ~ 2 1
    execute unless entity @e[tag=BulletOfPlayer_101,scores={Group_101=1}] at @e[tag=Player_101,type=item_display,scores={Group_101=1}] run summon item_display ~ ~ ~ {Tags:[Entity_101,Bullet_101,BulletOfPlayer_101,temp],item:{id:"minecraft:white_concrete",Count:1b},Rotation:[0f,-90f],transformation:[0.1f,0f,0f,0f, 0f,0.1f,0f,0f, 0f,0f,0.5f,0f, 0f,0f,0f,1f]}
    #idの設定
