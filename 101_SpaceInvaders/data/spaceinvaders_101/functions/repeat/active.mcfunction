...
## UFO
    ...
    execute as @e[tag=UFO_101,type=item_display,scores={Group_101=1,Timer_101=..0}] at @s run function spaceinvaders_101:unit/ufo/move
    # 撃墜演出
...
## ゲームオーバー
execute at @e[tag=StagePoint_101,type=marker,scores={Group_101=1}] positioned ~-10 ~-1 -46.5 if entity @e[tag=Invader_101,type=item_display,scores={Group_101=1},dx=19,dy=1,dz=1] run function spaceinvaders_101:game/fail
